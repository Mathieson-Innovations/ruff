...
pub fn code_to_rule(linter: Linter, code: &str) -> Option<(RuleGroup, Rule)> {
    ...
    Some(match (linter, code) {
        ...
        (Databricks, "009") => rules::databricks::rules::PatTokenLeaked,
        (Databricks, "010") => rules::databricks::rules::InternalApi,
        (Databricks, "011") => rules::databricks::rules::LegacyCli,
        (Databricks, "012") => rules::databricks::rules::IncompatibleWithUc,
        (Databricks, "013") => rules::databricks::rules::NotebooksTooManyCells,
        (Databricks, "014") => rules::databricks::rules::NotebooksPercentRun,
        (Databricks, "015") => rules::databricks::rules::SparkOutsideFunction,
        (Databricks, "016") => rules::databricks::rules::NoSparkArgumentInFunction,
        (Databricks, "017") => rules::databricks::rules::UseDisplayInsteadOfShow,
        (Databricks, "018") => rules::databricks::rules::ExplicitDependencyRequired,
        (Databricks, "019") => rules::databricks::rules::ObscureMock,
        (Databricks, "021") => rules::databricks::rules::MockNoAssign,
        (Databricks, "022") => rules::databricks::rules::MockNoUsage,
        (Databricks, "023") => rules::databricks::rules::RewriteAsForLoop,
        (Databricks, "024") => rules::databricks::rules::NotebooksPercentPip,
