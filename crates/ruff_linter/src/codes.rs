...
pub fn code_to_rule(linter: Linter, code: &str) -> Option<(RuleGroup, Rule)> {
    ...
    Some(match (linter, code) {
        ...
        // databricks
        (Databricks, "001") => rules::databricks::rules::MissingDataSecurityMode,
        (Databricks, "002") => rules::databricks::rules::UnsupportedRuntime,
        (Databricks, "003") => rules::databricks::rules::DbutilsFsCp,
        (Databricks, "004") => rules::databricks::rules::DbutilsFsHead,
        (Databricks, "005") => rules::databricks::rules::DbutilsFsLs,
        (Databricks, "006") => rules::databricks::rules::DbutilsFsMount,
        (Databricks, "007") => rules::databricks::rules::DbutilsCredentials,
        (Databricks, "008") => rules::databricks::rules::DbutilsNotebookRun,
        (Databricks, "009") => rules::databricks::rules::HardcodedDatabricksToken,
        (Databricks, "010") => rules::databricks::rules::DatabricksInternalApi,
        (Databricks, "011") => rules::databricks::rules::DatabricksLegacyCli,
        (Databricks, "012") => rules::databricks::rules::UnityCatalogIncompatible,
        (Databricks, "013") => rules::databricks::rules::TooManyNotebookCells,
        (Databricks, "014") => rules::databricks::rules::NotebookPercentRun,
        (Databricks, "015") => rules::databricks::rules::SparkOutsideFunction,
        (Databricks, "016") => rules::databricks::rules::UnpassedSparkReference,
        (Databricks, "017") => rules::databricks::rules::SparkDataFrameShow,
        (Databricks, "018") => rules::databricks::rules::ImplicitMockDependency,
        (Databricks, "019") => rules::databricks::rules::MagicMockUsage,
        (Databricks, "021") => rules::databricks::rules::UnassignedMock,
        (Databricks, "022") => rules::databricks::rules::UnusedMock,
        (Databricks, "023") => rules::databricks::rules::MultilineListComprehension,
        (Databricks, "024") => rules::databricks::rules::NotebookPercentPip,
